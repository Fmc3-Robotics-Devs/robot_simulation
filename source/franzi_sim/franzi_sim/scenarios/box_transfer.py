...
# Deterministic, limit-compliant neutral seed used only for camera and workcell
# review.  With both arms naturally hanging, the grippers and their rigidly
# mounted D405 optical axes point toward the floor.  Task-specific pre-grasp
# poses remain the responsibility of MoveIt in P3.
